...
<head>
	...
	<?php include'./application/views/admin/include/header.php';?>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Slider Table <small>Manage Sliders...</small></h1>
			<!-- end page-header -->
                            ...
                            <div class="note note-yellow m-b-15">
                                ...
                                <div class="note-content">
                                    ...
                                    <ul class="m-b-5 p-l-25">
                                        ...
                                        <li>The resolution of image file is <strong>1920x660</strong>.</li>
                                    </ul>
                                </div>
                            </div>
                            <form action="<?= base_url('SliderFormSubmit')?>" method="post" enctype="multipart/form-data" class="form-horizontal" data-parsley-validate="true" name="demo-form">
                                        <fieldset class="form-horizontal">

                                            
                                            <div class="form-group row m-b-15">
                                                <label class="col-md-4 col-sm-4 col-form-label" for="image"> Slider Name *</label>
                                                <div class="col-sm-7">
                                                        <input type="text" name="name" class="form-control" required autofocus="" placeholder="Enter Here A Slider Name" tabindex="1">
                                                    </div>
                                                </div>
                                            
                                            
                                            <div class="form-group row m-b-15">
                                                <label class="col-md-4 col-sm-4 col-form-label" for="image"> Slider Description *</label>
                                                <div class="col-sm-7">
                                                        <input type="text" name="description" class="form-control" required autofocus="" placeholder="Enter Here A Slider Description" tabindex="2">
                                                    </div>
                                                </div>
                                            
                                            <div class="form-group row m-b-15">
                                                <label class="col-md-4 col-sm-4 col-form-label" for="image"> Pick A Slider Image *</label>
                                                <div class="col-sm-7">
                                                        <input class="form-control" type="file" name="file_name" placeholder="Required" data-parsley-required="true" accept="image/x-png,image/gif,image/jpeg" />
                                                    </div>
                                                </div>
