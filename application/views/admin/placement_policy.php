...
<head>
	...
	<?php include'./application/views/admin/include/header.php';?>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Policy Table <small>Manage Policies...</small></h1>
			<!-- end page-header -->
			    ...
			    <div class="col-lg-8">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Update Policy Details...</h4>
                        </div>
                        <!-- end panel-heading -->
                        <!-- begin panel-body -->
                        <div class="panel-body">
                            <form action="<?= base_url('Policy')?>" method="post" enctype="multipart/form-data" class="form-horizontal" data-parsley-validate="true" name="demo-form">
                                                  ...
                                                  foreach($policy as  $value) {
                                                     ?>
                                                        ...
                                                        <div class="form-group row m-b-15">
                                                            <label class="col-md-4 col-sm-4 col-form-label" for="image"> Sub Product Name *</label>
                                                            <div class="col-sm-7">
